   ...
   public class Customer
    {
        ...
        {
            foreach (DataRow row in OrdersMySQL.Customers.Rows)
            {
        ...
        {
            DocumentReference Doc = DatabaseFirestore.DB.Collection("Orders").Document(IDORDERS).Collection("Customer").Document(ID);
